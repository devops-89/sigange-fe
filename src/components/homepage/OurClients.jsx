...
export default function OurClients() {
  return (
    <section className="bg-white py-12" id="clients">
      <div className="max-w-7xl mx-auto px-4">
        {/* Heading */}
        <div className="text-center mb-8">
          <h2 className="text-3xl text-gray-900 font-bold mb-2">Our Renowned Clients</h2>
        ...
        <div className="text-center mt-16">
          <h2 className="text-2xl font-semibold text-gray-900 mb-2">Registered With</h2>
          <div className="w-20 mx-auto h-[2px] bg-gray-300 mb-6" />

          <div className="flex justify-center">
            <img
              src="https://megasigns.ca/wp-content/uploads/2021/06/featured.png"
              alt="Alberta Sign Association"
